...
part pv.283 --fstype=lvmpv --ondisk=sda --size=1715327
volgroup os --pesize=4096 pv.283
logvol / --fstype=xfs --size=19072 --label=/ --name=root --vgname=os
logvol /var/lib/docker --fstype=xfs --size=1696248 --name=var_lib_docker --vgname=os
